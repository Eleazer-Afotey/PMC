                ...
                <div>
                                    ...
                                    <div class="sectionRight">
                                        <div class="sectionRight-flex sectionRight-container">
                                            <div class="sectionRight-link">
                                                <a href="./index" class="topHeader-link">For Landlords</a>
                                            </div>
                                            <div class="sectionRight-link">
                    ...
                    <div class="navBar">
                        <div class="navBar-inner">
                            ...
                            <div class="navItem">
                                <a href="#" class="nav-link">Renters Profile</a>
                            </div>
                            <div class="navItem">
                                <a href="#" class="nav-link">Online Rent Payment</a>
                            </div>
                            <div class="navItem">
                                <a href="#" class="nav-link">Digital Lease Signing</a>
                            </div>
                            <div class="navItem">
                                <a href="#" class="nav-link">Maintenance Tickets</a>
                            </div>
                            <div class="navItem">
                                <a href="#" class="nav-link">Find My Next Place</a>
                            </div>
                        </div>
                        <div class="user-auth">
